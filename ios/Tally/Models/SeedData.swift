...
enum SeedData {
    static let encounters: [Encounter] = [
        encounter("N8620H", "Boeing", "737-800", airline: "Southwest", livery: "Tennessee One", flight: "WN 1846", route: ("BNA", "DAL"), distance: 0.7, altitude: 3_200, rarity: .singular, score: 94, reasons: ["One active aircraft wears this livery", "Locally meaningful Tennessee scheme", "Your first Tennessee One tally"], colors: ("#233D72", "#D8B24C", "#C83A36")),
